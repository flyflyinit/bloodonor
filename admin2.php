...
echo "";
		...
		if (mysqli_query($conn, $sql)) {
			echo "<div class='alert alert-success' role='alert'>You added a donor succesffully!</div>";
		} else {
...
function preview_image(event) 
{
 ...
 reader.readAsDataURL(event.target.files[0]);
  ...
  <div class="container">
<form id="wrapper" action="admin2.php"  method="post" enctype="multipart/form-data">
<br>
<br>
